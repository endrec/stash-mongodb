...
helm repo update
helm install stash-mongodb-3.4 appscode/stash-mongodb -n kube-system --version=3.4
```
...
```console
helm uninstall stash-mongodb-3.4 -n kube-system
```
...
```console
helm install stash-mongodb-3.4 appscode/stash-mongodb -n kube-system --set docker.registry=my-registry
```
