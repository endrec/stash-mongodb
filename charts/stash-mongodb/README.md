...
helm repo update
helm install stash-mongodb-4.0 appscode/stash-mongodb -n kube-system --version=4.0
```
...
```console
helm uninstall stash-mongodb-4.0 -n kube-system
```
...
```console
helm install stash-mongodb-4.0 appscode/stash-mongodb -n kube-system --set docker.registry=my-registry
```
